                    ...
                    <div class="col-sm-12 col-md-3 col-lg-3">
                        <div class="dashboard_tab_button">
                            <ul role="tablist" class="nav flex-column dashboard-list">
                                <li><a href="#account-details" data-toggle="tab" class="nav-link">Tài khoản của tôi</a>
                                </li>
                                        ...
                                        <tbody>
                                            <c:forEach items="${bill}" var="b">
                                                <tr>
                                                    ...
                                                    <td>${b.total}</td>
                                                    <td><a href="user?action=showdetail&bill_id=${b.bill_id}"
                                        ...
                                        <div class="account_login_form">
                                            <form action="user?action=updateinfo" method="POST">
                                                ...
                                                <input type="password" name="user_pass"
                                                    value="${sessionScope.user.user_pass}">
