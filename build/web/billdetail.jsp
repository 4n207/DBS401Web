            ...
            <div class="container">  
                <form> 
                    <div class="row">
                        ...
                        <div colspan="6" class="actions" style="margin-bottom: 20px;">
                            <a href="user?action=downloadBillDetail&billId=${bill_id}" class="btn btn-primary">Tải xuống chi tiết hóa đơn</a>
                        </div>
                    </div>
                </form> 
            </div>     
